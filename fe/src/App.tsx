...
function PublicApp({ onLogin }: PublicAppProps) {
  ...
  function ServiceDetailRouteWrapper() {
    ...
    return (
      <>
        ...
        <ServiceDetail
          ...
          onBooking={(sid) => handleBookingClick(sid)}
  ...
  function DoctorDetailRouteWrapper() {
    ...
    return (
      <>
        ...
        <DoctorDetailRemote
          ...
          onBooking={(did) => handleBookingClick(undefined, did)}
        />
        <PublicFooter />
      </>
    );
    ...
    <div className="min-h-screen bg-[#fcfeff]">
      ...
      <Routes>
        ...
        <Route
          ...
          element={<ServiceDetailRouteWrapper />}
        />
        <Route
          path="/doctors"
          element={
            <>
              ...
              <DoctorsListRemote
                ...
                onBooking={(doctorId) =>
                  handleBookingClick(undefined, doctorId)
                }
              />
              <PublicFooter />
            </>
        ...
        <Route
          ...
          element={<DoctorDetailRouteWrapper />}
        />
        <Route
          path="/about"
          element={
                ...
                <div className="container mx-auto">
                  ...
                  <div className="space-y-[24px] max-w-[800px]">
                    <p className="font-['Fz_Poppins:Regular',sans-serif] text-[#333333] text-[18px] leading-[1.8]">
                      DentalCareX là phòng khám nha khoa uy tín hàng đầu tại
                      Việt Nam với hơn 15 năm kinh nghiệm trong lĩnh vực chăm
                      sóc và điều trị răng miệng.
                    </p>
                    <p className="font-['Fz_Poppins:Regular',sans-serif] text-[#333333] text-[18px] leading-[1.8]">
                      Chúng tôi cam kết mang đến cho khách hàng những dịch vụ
                      nha khoa chất lượng cao nhất với công nghệ hiện đại, đội
                      ngũ bác sĩ giàu kinh nghiệm và quy trình chăm sóc chuyên
                      nghiệp.
                    </p>
                  </div>
                </div>
        ...
        <Route
          ...
          element={
            <PaymentResultPage
              onNavigate={(page) => handleNavigate(page === "home" ? "/" : `/${page}`)}
            />
          }
        />
