import svgPaths from "./svg-fyu7v1is0e";
...
function Group2() {
  return (
    <div className="absolute contents left-[calc(50%+392px)] top-[278px] translate-x-[-50%]">
      <div className="absolute bg-[#fcfeff] h-[60px] left-[calc(50%+392px)] rounded-[10px] top-[278px] translate-x-[-50%] w-[360px]">
        <div aria-hidden="true" className="absolute border border-[#05619a] border-solid inset-0 pointer-events-none rounded-[10px]" />
      </div>
      <Group />
    </div>
  );
...
function Frame() {
  return (
    <div className="absolute content-stretch flex gap-[9px] items-start left-[calc(50%+222.5px)] top-[830px] translate-x-[-50%]">
      ...
      <p className="absolute font-['Fz_Poppins:Regular',sans-serif] leading-[1.55] left-[160.5px] not-italic text-[#00446f] text-[14px] text-center text-nowrap top-[-4px] tracking-[0.28px] translate-x-[-50%] whitespace-pre">Tôi đồng ý với Điều khoản và Điều kiện</p>
    </div>
  );
}
...
function Group3() {
  return (
    <div className="absolute contents left-[calc(50%+392px)] top-[414px] translate-x-[-50%]">
      ...
      <div className="absolute flex flex-col font-['Fz_Poppins:Regular',sans-serif] h-[60px] justify-center leading-[0] left-[calc(50%+261px)] not-italic text-[14px] text-[darkgrey] top-[444px] tracking-[0.28px] translate-y-[-50%] w-[147px]">
        <p className="leading-[1.55]">Nhập Email của bạn</p>
      </div>
      <Envelope />
    </div>
  );
...
function Group6() {
  return (
    <div className="absolute contents left-[calc(50%+392px)] top-[495px] translate-x-[-50%]">
      ...
      <div className="absolute flex flex-col font-['Fz_Poppins:Regular',sans-serif] h-[60px] justify-center leading-[0] left-[calc(50%+255px)] not-italic text-[14px] text-[darkgrey] top-[525px] tracking-[0.28px] translate-y-[-50%] w-[304px]">
        <p className="leading-[1.55]">Nhập họ tên của bạn</p>
      </div>
      <User />
    </div>
  );
...
function Group7() {
  return (
    <div className="absolute contents left-[calc(50%+392px)] top-[580px] translate-x-[-50%]">
      ...
      <div className="absolute flex flex-col font-['Fz_Poppins:Regular',sans-serif] h-[60px] justify-center leading-[0] left-[calc(50%+254.609px)] not-italic text-[14px] text-[darkgrey] top-[610px] tracking-[0.28px] translate-y-[-50%] w-[316.522px]">
        <p className="leading-[1.55]">Nhập số điện thoại</p>
      </div>
      <User1 />
    </div>
  );
...
function Group4() {
  return (
    <div className="absolute contents left-[calc(50%+392px)] top-[663px] translate-x-[-50%]">
      ...
      <div className="absolute flex flex-col font-['Fz_Poppins:Regular',sans-serif] h-[60px] justify-center leading-[0] left-[calc(50%+254.609px)] not-italic text-[14px] text-[darkgrey] top-[693px] tracking-[0.28px] translate-y-[-50%] w-[316.522px]">
        <p className="leading-[1.55]">Mật khẩu</p>
      </div>
      <Lock />
    </div>
  );
...
function Group5() {
  return (
    <div className="absolute contents left-[calc(50%+392px)] top-[746px] translate-x-[-50%]">
      ...
      <div className="absolute flex flex-col font-['Fz_Poppins:Regular',sans-serif] h-[60px] justify-center leading-[0] left-[calc(50%+255.478px)] not-italic text-[14px] text-[darkgrey] top-[776px] tracking-[0.28px] translate-y-[-50%] w-[316.522px]">
        <p className="leading-[1.55]">Xác nhận mật khẩu</p>
      </div>
      <Lock1 />
    </div>
  );
...
function Group8() {
  return (
    <div className="absolute contents left-[calc(50%+390px)] top-[204px] translate-x-[-50%]">
      ...
      <div className="absolute bg-[#3fb5ff] box-border content-stretch flex h-[56px] items-center justify-between left-[calc(50%+392px)] overflow-clip p-[10px] rounded-[15px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[869px] translate-x-[-50%] w-[224px]" data-name="Button/1">
...
export default function SignUpPage() {
  return (
    <div className="bg-[#fcfeff] relative size-full" data-name="SignUpPage">
      <Group8 />
      <div className="absolute h-[1004px] left-[calc(50%-338px)] rounded-tr-[10px] top-[84px] translate-x-[-50%] w-[808px]">
      ...
      <div className="absolute bg-[#fcfeff] h-[104px] left-0 right-0 top-0" data-name="Header/1">
        <Header />
        <Logo />
