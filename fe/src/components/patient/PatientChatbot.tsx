...
// import ReactMarkdown from 'react-markdown'; // <--- IMPORT THƯ VIỆN MỚI
//
...
//
//   // --- 1. LOGIC LOCAL RESPONSE ---
//   const getLocalResponse = (userMessage: string): { text: string; quickReplies?: string[] } | null => {
//     const lowerMessage = userMessage.toLowerCase();
//
//     // Logic trả lời nhanh giữ nguyên như cũ
//     if (lowerMessage.includes('giờ') || lowerMessage.includes('mở cửa') || lowerMessage.includes('làm việc')) {
//       return {
//         text: '**Giờ làm việc phòng khám:**\n\n🕐 **09:00 - 21:00**\n📅 Tất cả các ngày trong tuần (kể cả Lễ, Tết)\n\nBạn muốn đặt lịch hẹn không?',
//         quickReplies: ['Đặt lịch hẹn', 'Xem dịch vụ']
//       };
//     }
...
//         quickReplies: ['Chỉ đường', 'Đặt lịch hẹn']
//       };
//     }
//     return null;
//   };
...
//           sender: 'bot',
//           timestamp: new Date(),
//           quickReplies: localRes.quickReplies
//         };
...
//           sender: 'bot',
//           timestamp: new Date(),
//           quickReplies: ['Đặt lịch hẹn', 'Tư vấn thêm']
//         };
//         setMessages(prev => [...prev, botMsg]);
//       } else {
