...
const faqData = [
    {
        ...
        answer: 'Chúng tôi làm việc từ 9h00 đến 21h00, tất cả các ngày trong tuần bao gồm cả Lễ và Tết.'
    },
    {
        question: 'Tôi có cần đặt lịch trước không?',
        answer: 'Chúng tôi khuyến khích bạn đặt lịch trước để đảm bảo được phục vụ đúng giờ. Tuy nhiên, chúng tôi cũng nhận khách không cần hẹn trước.'
    },
    {
        question: 'Chi phí điều trị có đắt không?',
        answer: 'Chúng tôi có bảng giá minh bạch và cạnh tranh. Mỗi ca điều trị sẽ được tư vấn chi tiết về chi phí trước khi thực hiện.'
    },
    {
        question: 'Phòng khám có chấp nhận bảo hiểm y tế không?',
        answer: 'Có, chúng tôi chấp nhận đa số các loại bảo hiểm y tế. Vui lòng liên hệ để biết thêm chi tiết.'
    }
];
                ...
                <div className="max-w-[1440px] mx-auto">
                  ...
                  Công nghệ nha khoa hiện đại
                            ...
                            <p className="font-['Fz_Poppins:Regular',sans-serif] text-[#666666] text-[18px] leading-[1.8]">
                                Phòng khám nha khoa DentalCareX - Nơi mang đến những giải pháp chăm sóc răng miệng toàn diện với công nghệ tiên tiến và đội ngũ bác sĩ giàu kinh nghiệm.
                            </p>
            ...
            <section className="py-[80px] px-[20px] md:px-[80px] bg-white">
                ...
                Dịch vụ của chúng tôi
                        ...
                        <p className="font-['Fz_Poppins:Regular',sans-serif] text-[#666666] text-[18px] max-w-[600px] mx-auto">
                            Chúng tôi cung cấp đầy đủ các dịch vụ nha khoa từ cơ bản đến nâng cao với công nghệ hiện đại nhất
                        </p>
                    </div>
                    ...
                    <div className="mb-[60px] bg-white rounded-[32px] p-[40px] shadow-[0px_10px_40px_0px_rgba(0,0,0,0.08)]">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[40px] items-center">
                            ...
                            <div className="space-y-[24px]">
                                ...
                                <div className="flex items-center gap-[8px]">
                                    {[...Array(5)].map((_, i) => (
                                        <Star key={i} className="w-[20px] h-[20px] fill-[#ffd700] text-[#ffd700]" />
                                    ))}
            ...
            <section className="py-[80px] px-[20px] md:px-[80px] bg-[#3fb5ff]">
                <div className="max-w-[1000px] mx-auto text-center">
                    ...
                    <p className="font-['Fz_Poppins:Regular',sans-serif] text-white/90 text-[18px] mb-[40px] max-w-[700px] mx-auto">
                        Đặt lịch hẹn ngay hôm nay để được tư vấn miễn phí từ đội ngũ bác sĩ chuyên nghiệp của chúng tôi
                    </p>
