package com.main_project.inventory_service.configuration;

import com.main_project.inventory_service.configuration.filter.CustomRequestFilter;
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/inventory-service/dispense-orders/prescription/**").permitAll()
                                ...
                                .requestMatchers("/inventory-service/dispense-orders/medical-history/**").permitAll()
